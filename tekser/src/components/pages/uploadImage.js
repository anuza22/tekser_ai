  ...
  return (
    <MainLayout>
      <div className="flex flex-col flex-1 justify-center items-center px-10" id="upload">
        <h1 className="font-poppinsSemiBold text-3xl mt-16 text-center">Upload Your Homework</h1>
        ...
        {loading ? (
          <MoonLoader className="mt-40" size={150} color="#7F56D9" loading={true} />
        ) : (
          <div className="flex flex-col justify-center items-center">
            <div className="mt-6 text-primary-400 text-lg rounded-xl bg-primary-50 px-3 py-2" id="uploaded_number">
              <span className="font-poppinsSemiBold text-primary-600 text-3xl">{selectedFiles ? selectedFiles.length : 0}</span> / 20
            </div>
